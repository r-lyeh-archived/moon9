// original code by Elbert Mai 
// modified by rlyeh to suit my needs :)

// callback.hpp Version 1.0 - December 14, 2010: Initial release
// ref: http://www.codeproject.com/Articles/136799/Lightweight-Generic-C-Callbacks-or-Yet-Another-Del

#pragma once

// @rlyeh: -BIND_FREE_CB +make_callback_function
#define make_callback_function(freeFuncPtr) \
    (moon9::GetCallbackFactory(freeFuncPtr).Bind<freeFuncPtr>())  // rlyeh: -util +moon9

// @rlyeh: -BIND_MEM_CB(M,P) +make_callback_method(P,M)
#define make_callback_method(instancePtr, memFuncPtr) \
    (moon9::GetCallbackFactory(memFuncPtr).Bind<memFuncPtr>(instancePtr)) // rlyeh: -util +moon9

#define Callback callback // @rlyeh +
#define NullCallback callback_null // @rlyeh +

namespace moon9 { // rlyeh: -util +moon9
...
#undef NullCallback // @rlyeh +
#undef Callback // @rlyeh +
